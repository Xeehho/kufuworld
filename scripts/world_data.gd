...
## ============ 唐制城池蓝图（W2） ============
## 市坊分离、棋盘路网、中轴居北、四门官道。rect 为相对城心偏移（格）。
const CITY_V2 := {
	"half": 30,
	"main_street_w": 4,       # 朱雀大街/东西大街（直通四门）
	"second_street_w": 2,     # 平行次街
	"wards": {                # 四大居住坊+官署坊+寺观坊（坊墙1格+坊门2格）
		"官署坊": Rect2i(-26, -26, 20, 18),
		"寺观坊": Rect2i(6, -26, 20, 18),
		"西坊":   Rect2i(-26, 2, 20, 20),
		"东坊":   Rect2i(6, 2, 20, 20),
	},
	"markets": {              # 东西两市（行肆集中，唐制"市"外不临街开店）
		"西市": Rect2i(-16, 24, 14, 8),
		"东市": Rect2i(2, 24, 14, 8),
	},
