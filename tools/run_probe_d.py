# -*- coding: utf-8 -*-
"""Phase D probe runner: temp-inject ProbeAutoload -> run game -> restore project.godot."""
...
gp = os.path.join(proj, "tools", "probe_game_stdout.txt")
with open(pg, encoding="utf-8") as f:
    original = f.read()
marker = 'ProbeAutoload="*res://tools/probe_phase_d.gd"'
killed = False
try:
...
sys.stdout.buffer.write(("\n".join(log.splitlines()[-55:])).encode("utf-8"))