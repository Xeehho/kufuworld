# -*- coding: utf-8 -*-
"""Round2 probe runner: temp-inject ProbeRound2 -> run game -> restore project.godot."""
...
lp = os.path.join(proj, "tools", "probe_round2_log.txt")
gp = os.path.join(proj, "tools", "probe_round2_stdout.txt")
with open(pg, encoding="utf-8") as f:
    original = f.read()
marker = 'ProbeR2="*res://tools/probe_round2.gd"'
try:
