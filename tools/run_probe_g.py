# -*- coding: utf-8 -*-
"""Phase G probe runner: temp-inject ProbeG -> windowed run -> restore project.godot."""
...
lp = os.path.join(proj, "tools", "probe_g_log.txt")
gp = os.path.join(proj, "tools", "probe_g_stdout.txt")
with open(pg, encoding="utf-8") as f:
    original = f.read()
marker = 'ProbeG="*res://tools/probe_phase_g.gd"'
try:
