# -*- coding: utf-8 -*-
"""地形掺杂调查 runner: temp-inject ProbeTmixShots -> run game -> restore project.godot."""
...
gp = os.path.join(proj, "tools", "probe_tmix_shots_stdout.txt")
marker = 'ProbeTmixShots="*res://tools/probe_tmix_shots.gd"'
...
log = os.path.join(proj, "tools", "probe_tmix_shots_log.txt")
