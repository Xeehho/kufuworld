...
- **去墙小街区（第五轮 2026-09-07 起）**：坊=开放街区组——坊墙圈/坊门/坊门楼全退役，坊内十字巷(2宽)+巷排排屋（巷北排 y0+8/巷南排 y0+18 背靠背，脚行距≥6 防檐叠）；市墙市门/宫墙/外郭城墙/剧情坊 lot 院墙保留（宵禁册/礼制/传送门锚定）；宵禁仅剩两市 4×2 门；生成末尾自动 unlock_stage(1/2) 全城解锁（体验模式剧情冻结）
- **无空地纪律**：坊范围内禁裸草——地坪 74/101 铺满，绿化只做园池口袋；临街面店排/摊排连续
