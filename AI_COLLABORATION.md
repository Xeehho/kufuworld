...
### 2026-09-12 21:29｜视觉世界线｜整城统一第四轮

- 状态：阶段完成；四边外郭墙与四门已统一，曲江/城南长河和宫城高台已形成城市级水系与首个真实高差纵切，后续继续补角件、台地四向套件与院落侧背面。
- 改动文件：三张 Image 2.0 生成源及四张透明派生件、`tools/import_sckr_changan.py`、`data/sckr_manifest.json`、`scripts/changan_v2_generator.gd`、`scripts/changan_v2_materials.gd`、结构/E2E 探针、长安样张和差距清单。
- 完成内容：补同族横向墙顶 A/B、南北门桥、宫城宽台基/中央阶梯；曲江扩成长池，城南加五格宽长河与明德门石桥。所有生成件保留源图、固定源窗、真 Alpha、整数模数和 manifest 语义；没有旋转正面素材冒充侧向件。
- 稳定接口变化：无破坏性变化；168×142、28 坊、四门 side、`gate_info`、Portals、街区 id、冻结主街、BFS 和共享热点均保持。新增 `changan_terrace`、`changan_river_bridge` 仅用于视觉/物理探针。
- 验证命令与结果：结构 PASS（336 材质、118 阴影、98 碰撞、40 NPC、BFS=0）；窗口样张 14/14；主场景 E2E 全 PASS；开放世界 94/94 PASS。
